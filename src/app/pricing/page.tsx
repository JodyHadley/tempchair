...
const tiers = [
  ...
  },
  {
    ...
    features: [
      ...
      "Browse qualified worker profiles",
      "Public ratings and reviews",
      "Chat with applicants (coming soon)",
  ...
  },
  {
    ...
    badge: "Best Value",
    description:
      "Everything in Standard plus private reviews and priority access to top talent.",
    cta: "Go Premium",
    ...
    features: [
      ...
      "Write private/blind reviews of workers",
      "See private reviews from other premium clinics",
      "AI-powered worker matching (coming soon)",
      "Priority support",
    ],
  },
];
